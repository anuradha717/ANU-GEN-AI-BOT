...
UI_TITLE = os.environ.get("UI_TITLE") or "Anuradha Samaranayake | Driving Digital Transformation with Cutting Edge Solutions"
UI_LOGO = os.environ.get("UI_LOGO")
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO")
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Start chatting"
UI_CHAT_DESCRIPTION = (
    os.environ.get("UI_CHAT_DESCRIPTION")
    or "This Generative AI Assistance, Developed and Trained by Anuradha, has detailed Knowledge of his Professional background and Expertise"
)
